I'm a hands-on CTO and Co-Founder at Vassago, building the data layer for the AI search era. Over 20+ years I've led R&D across startups and global enterprises, with deep expertise in agentic AI, vector infrastructure, and massive-scale cloud/SaaS systems serving 2B+ users.

Most recently I led Meta's authentication services, managing products that impact over 2 billion users. Earlier I held VP of R&D roles across cybersecurity, adtech, and mobile — including at Somoto, where I multiplied revenues while reducing serving costs. My stack spans Kubernetes, microservices, Postgres, MongoDB, and modern AI tooling (LLMs, vector DBs, agent SDKs).

I build and scale both technical systems and the teams behind them, with a strong focus on efficiency, security, and user experience.
